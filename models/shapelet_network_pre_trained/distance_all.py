...
class MinEuclideanDistBlock(nn.Module):
    ...
    def forward(self, x,previous_distance):
        """
       ...
       # print(x.dtype,self.shapelets.dtype,'**********x.dtype,self.shapelets.dtype')
        ...
        if previous_distance=='transform':
            ...
            finally_distance=torch.where(x<previous_distance,x,previous_distance)
